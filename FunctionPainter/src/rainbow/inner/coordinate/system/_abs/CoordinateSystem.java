package rainbow.inner.coordinate.system._abs;

import java.awt.Image;
import java.awt.Point;

import rainbow.inner.coordinate.system._abs.comp.CoordinateSystemLocationGetter;
import rainbow.inner.coordinate.system._abs.comp.CoordinateSystemPainter;
...
public abstract class CoordinateSystem {
     ...
     * @return 转换之后的点
     */
    public rainbow.inner.math.points.MyPoint toSystem(Point point) {
     ...
     * @return 转换之后的点
     */
    public Point toReal(rainbow.inner.math.points.MyPoint point) {
